        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-5">
            <div className="glass-card p-7">
              <h2 className="font-display font-bold text-white text-xl mb-5">Institute Address</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <MapPin size={18} className="text-brand-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <div className="text-white font-medium">Indian Institute of Information Technology, Pune</div>
                    <div className="text-dark-400 text-sm mt-1">
                      Survey No. 149/1, ITI Road, Pune<br />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+912029042000" className="text-white hover:text-brand-400 transition-colors">+91-20-2904-2000</a>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:registrar@iiitp.ac.in" className="text-white hover:text-brand-400 transition-colors">registrar@iiitp.ac.in</a>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-white text-sm">Mon – Fri: 9:00 AM – 5:30 PM</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-7">
              <h2 className="font-display font-bold text-white text-xl mb-5">Department Contacts</h2>
              <div className="space-y-3">
                {[
                  ...
                  <div key={dept} className="flex justify-between items-center text-sm">
                    <span className="text-dark-400">{dept}</span>
                    <a href={`mailto:${email}`} className="text-brand-400 hover:text-brand-300 transition-colors">{email}</a>
                  </div>
                ))}
              </div>
            </div>
